    ...
    <main className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl md:text-3xl font-bold text-[oklch(0.31_0.04_250)] mb-8">
              ...
              <div className="space-y-6 mb-12">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[oklch(0.95_0.12_150)] flex items-center justify-center flex-shrink-0">
                      <Phone className="h-5 w-5 text-[oklch(0.55_0.15_150)]" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Телефон</div>
                      <a href="tel:+79140875484" className="text-lg font-semibold text-[oklch(0.31_0.04_250)] hover:text-[oklch(0.72_0.18_150)] transition-colors">
                        +7 (914) 087-54-84
                      </a>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[oklch(0.95_0.12_150)] flex items-center justify-center flex-shrink-0">
                      <Mail className="h-5 w-5 text-[oklch(0.55_0.15_150)]" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[oklch(0.95_0.12_150)] flex items-center justify-center flex-shrink-0">
                      <MapPin className="h-5 w-5 text-[oklch(0.55_0.15_150)]" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[oklch(0.95_0.12_150)] flex items-center justify-center flex-shrink-0">
                      <Clock className="h-5 w-5 text-[oklch(0.55_0.15_150)]" />
                    </div>
                    <div>
              ...
              {/* Social Links */}
              <div>
                <h3 className="text-xl font-bold text-[oklch(0.31_0.04_250)] mb-4">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-[oklch(0.97_0_0)] flex items-center justify-center hover:bg-[oklch(0.72_0.18_150)] hover:text-white transition-colors text-[oklch(0.31_0.04_250)]"
                  >
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="bg-[oklch(0.97_0_0)] rounded-3xl p-6 md:p-10">
                <h2 className="text-2xl md:text-3xl font-bold text-[oklch(0.31_0.04_250)] mb-6">
                  Оставить заявку
                </h2>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                ...
                                className="min-h-[120px] rounded-xl border-gray-200 focus:border-[oklch(0.72_0.18_150)] focus:ring-[oklch(0.72_0.18_150)] resize-none"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
      ...
      <section className="py-20 bg-[oklch(0.97_0_0)]">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-[oklch(0.31_0.04_250)]">
              Наш офис
            </h2>
          </motion.div>
          <div className="rounded-2xl overflow-hidden shadow-lg h-[400px] bg-gray-200 flex items-center justify-center">
            <div className="text-center p-8">
              <MapPin className="h-12 w-12 text-[oklch(0.72_0.18_150)] mx-auto mb-4" />
              <h3 className="text-xl font-bold text-[oklch(0.31_0.04_250)] mb-2">Москва, Россия</h3>
